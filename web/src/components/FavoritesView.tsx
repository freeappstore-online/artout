  ...
  if (!user) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center gap-5 p-8 text-center">
        <p className="display-font text-2xl text-[var(--ink)]">Your collection</p>
        <p className="text-sm text-[var(--muted)]">Sign in to save your favorite spots.</p>
  ...
  if (favPosts.length === 0) {
    return (
      <div className="flex flex-1 items-center justify-center p-8 text-center text-[var(--muted)]">
        <div>
          <p className="display-font text-xl text-[var(--ink)]">No favorites yet</p>
